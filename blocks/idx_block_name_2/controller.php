<?php
/**
 * IDX Publisher Controller File.
 *
 * @author   Doug Forester <doug.forester@gmail.com>
 * @license  See attached license file
 */

namespace Concrete\Package\IdxPublisherPackage\Block\IdxBlockName2;
...
class Controller extends BlockController
{
     ...
     * @var string
     */
    protected $btName = 'IDX Publisher';
     ...
     * @var string
     */
    protected $btDescription = 'IDX Broker Package for Concrete';
     ...
     * @var string
     */
    protected $btHandle = 'idx_publisher';
     ...
     * @var string
     */
    protected $btTable = 'btIdxPublisher';
