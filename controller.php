<?php
/**
 * IDX Publisher Package Controller File.
 *
 * @author   Doug Forester <doug.forester@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\IdxPublisherPackage;
 ...
 *
 * IDX Broker Package for Concrete
 *
 * @author   Doug Forester <doug.forester@gmail.com>
 * @license  See attached license file
 */
class Controller extends Package
{
     ...
     * @var string
     */
    protected $pkgHandle = 'idx_publisher_package';
     ...
     * @var string
     */
    protected $pkgName = 'IDX Publisher Package';
     ...
     * @var string
     */
    protected $pkgDescription = 'IDX Broker Package for Concrete';
    ...
    public function install()
    {
        ...
        $theme = BlockType::installBlockType('idx_publisher', $pkg);
